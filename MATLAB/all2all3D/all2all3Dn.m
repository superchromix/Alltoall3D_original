function param = all2all3Dn(ptc1, ptc2, sig1, sig2, nIteration, gauss_transform_scale, USE_GPU_GAUSSTRANSFORM, USE_GPU_EXPDIST)
...
%     qtmp = angle2quat(ang(init_iter), 0, 0);
    ...
    f_config.scale = gauss_transform_scale;     % TODO  (JKF) Should sig1,sig2 not also be used in gmmreg_L23D? Currently only used for cost calculation?
